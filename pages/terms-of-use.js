  ...
  return (
    <>
      ...
      <div className={`container ${styles.termsContainer}`}>
        ...
        <p className={styles.termsText}>By using DemoShop, you agree to our terms and conditions. Please read them carefully before making a purchase.</p>
        <ul className={styles.termsList}>
          <li>All sales are final unless stated otherwise.</li>
          <li>DemoShop reserves the right to modify these terms at any time.</li>
